"""OuterClient 7.4.1 packaged entry point."""
...
from outerclient_v740_patch import install as apply_v740
from outerclient_v741_patch import install as apply_v741

apply_v730(_outerclient)
apply_v731(_outerclient)
apply_v732(_outerclient)
apply_v740(_outerclient)
apply_v741(_outerclient)
